...
# views.py 기준
from ais.chatbot.config.GlobalParams import *
from ais.chatbot.utils.Database import Database
from ais.chatbot.utils.Preprocess import Preprocess
from ais.chatbot.models.intent.IntentModel import IntentModel
from ais.chatbot.models.ner.NerModel import NerModel
from ais.chatbot.utils.FindAnswer import FindAnswer

class Chatbot:
    def proc(selfself, query):
        # 전처리 객체 생성
        # p = Preprocess(word2index_dic='./chatbot/dict/chatbot_dict.bin', userdic='./chatbot/dict/user_dic.tsv')
        # views.py
        p = Preprocess(word2index_dic='./ais/chatbot/dict/chatbot_dict.bin',
                             userdic='./ais/chatbot/dict/user_dic.tsv')
        ...
        # views.py
        intent = IntentModel(model_name='./ais/chatbot/models/intent/intent_model.h5', proprocess=p)
        ...
        # views.py
        ner = NerModel(model_name='./ais/chatbot/models/ner/ner_model.h5', proprocess=p)
